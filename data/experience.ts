...
export const experience: ExperienceItem[] = [
  ...
  { role: 'Freelancer Frontend Developer', company: 'Personal Projects', period: '2023 — Present', description: 'Building responsive web interfaces, portfolios and interactive components. Using HTML, CSS, JavaScript and modern frameworks like React and Next.js.', icon: '🎨' },
]
