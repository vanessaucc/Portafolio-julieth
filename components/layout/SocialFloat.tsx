const links = [
  ...
  { href: 'https://www.instagram.com/mena_julieth_/?hl=es',      icon: 'fab fa-instagram',    title: 'Instagram' },
  { href: 'https://www.facebook.com/vanessa.mena.206258/',        icon: 'fab fa-facebook-f',   title: 'Facebook' },
  { href: '#contact',                                             icon: 'fas fa-envelope',     title: 'Contacto' },
  { href: '#home',                                                icon: 'fas fa-arrow-up',     title: 'Subir' },
]
...
export default function SocialFloat() {
  return (
    <div className="fixed right-6 top-1/2 -translate-y-1/2 flex flex-col gap-2.5 z-[99] max-[900px]:hidden">
      {links.map(l => (
        <a key={l.title} href={l.href} title={l.title}
