  ...
  return (
    <>
      ...
      <aside className={`fixed top-0 left-0 w-[220px] h-screen bg-[linear-gradient(160deg,#22182c_0%,#2e1a47_100%)] flex flex-col items-center px-4 py-7 pb-6 z-[200] border-r border-brand-400/15 overflow-y-auto scrollbar-none transition-transform duration-300 max-[900px]:${open ? 'translate-x-0' : '-translate-x-full'}`}>
        ...
        <p className="text-[0.65rem] text-brand-300 text-center uppercase tracking-[0.1em]">Ing. Software</p>
        ...
        <div className="flex gap-1.5 mb-3 flex-wrap justify-center">
          {[
            ...
            { href: 'https://www.instagram.com/mena_julieth_/?hl=es',      icon: 'fab fa-instagram' },
            { href: 'https://www.facebook.com/vanessa.mena.206258/',        icon: 'fab fa-facebook-f' },
          ].map(s => (
