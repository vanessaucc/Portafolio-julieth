  ...
  return (
    ...
    >
      ...
      <div className="section-inner grid grid-cols-2 gap-12 items-center max-lg:gap-8 max-[768px]:grid-cols-1 max-[768px]:text-center">
        ...
        {/* Text — staggered entry animations */}
        <div className="flex flex-col max-[768px]:items-center max-[768px]:order-2">
          <span
            className="flex items-center gap-2 font-display text-[0.7rem] font-bold tracking-[0.2em] uppercase text-brand-500 mb-4 before:content-[''] before:inline-block before:w-5 before:h-0.5 before:bg-brand-500 max-[768px]:justify-center hero-fade-up"
          ...
          <h1
            className="font-display text-[clamp(2.4rem,5vw,4.2rem)] font-extrabold text-ink-primary leading-[1.06] mb-5 hero-fade-up"
          ...
          <div
            className="flex flex-wrap gap-2 mb-6 max-[768px]:justify-center hero-fade-up"
          ...
          <p
            className="text-[0.95rem] leading-[1.8] text-ink-secondary max-w-[440px] mb-8 max-[768px]:max-w-full hero-fade-up"
          ...
          <div
            className="flex gap-3 flex-wrap max-[768px]:justify-center hero-fade-up"
          ...
          {/* Stats */}
          <div
            className="flex gap-10 mt-10 max-[768px]:justify-center max-[768px]:mt-6 hero-fade-up"
        ...
        {/* Photo */}
        <div
          className="flex items-center justify-center max-[768px]:order-1 max-[768px]:mt-4 hero-fade-up"
          style={{ animationDelay: '0.2s' }}
        >
          <div className="relative">
            <div className="absolute -inset-4 rounded-[32px] bg-gradient-to-br from-brand-400/25 to-brand-600/15 blur-2xl animate-float-alt" />
